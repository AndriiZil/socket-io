// Where all our main socket.io stuff will go
...
// issue a message to EVERY connected socket.io 30 fps
setInterval(()=>{
    if(players.length > 0){
...
io.sockets.on('connect',(socket)=>{
    ...
    // the client sent over a tick. That means we know what direction to move the socket.io
    socket.on('tick',(data)=>{
        ...
        capturedOrb.then((data)=>{
            ...
            // console.log(orbData)
            // every socket.io needs to know the leaderBoard has changed
